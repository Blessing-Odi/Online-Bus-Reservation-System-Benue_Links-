...
while($row = mysql_fetch_array($result))
  {
  $a=$row['room_id'];
  $query = mysql_query("SELECT sum(qty_reserve) FROM businventory where arrival <= '$arival' and departure >= '$departure' and room_id='$a'");
...
<div class="footer" style="text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:12px;">copyright © U11CS1090
</html>
