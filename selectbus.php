...
<?php
//lotus.x10hosting.com:2083/frontend/x3/filemanager/editit.html?file=selectbus.php&fileop=&dir=%2Fhome%2Fargie%2Fpublic_html&dirop=&charset=&file_charset=windows-1252&baseurl=&basedir=
...
<div class="mainwrapper">
  ...
  <label style="margin-left: 119px;">Number of seats: </label><INPUT id="txtChar" onkeypress="return isNumberKey(event)" type="text" name="no_rooms" class="ed">
 <span id="errmsg"></span>
  <br />
  <br />
<?php
...
<label style="margin-left: 16px;">In Date : <?php echo $arival; ?></label><br />
<label style="margin-left: 3px;"> Out Date : <?php echo $departure; ?></label><br />
...
<div class="footer" style="text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:12px;">copyright ©u11cs1090All Rights reserved</div>
</body>
</html>
